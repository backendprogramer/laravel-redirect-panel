...
return [
    ...
    'structure_path_from' => 'In the "Path from" field, you can use the characters */ at the beginning of the path, /*/ in the middle of the path, and /* at the end of the path, such as:',
